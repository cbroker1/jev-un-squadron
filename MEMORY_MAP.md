...
Full measurements, run IDs and screenshots: [aircraft slot validation](hazard_observation/AIRCRAFT_SLOTS_2026-09-19.md), [combat segment report](hazard_observation/COMBAT_SEGMENT_2026-09-19.md), [brain adoption report](hazard_observation/BRAIN_ADOPTION_2026-09-19.md) and [initial projectile validation](hazard_observation/PROJECTILE_VALIDATION_2026-09-19.md). Resume instructions: [CLAUDE_HANDOFF.md](CLAUDE_HANDOFF.md).
...
- This is consistent with a collision, but it is not a collision, health or death mapping. See [the pause-and-step report](hazard_observation/PAUSE_AND_STEP_2026-09-19.md).
