-- Focused first-damage observation. No controls, no Jev.
memory.usememorydomain("WRAM")
client.unpause()
local root="C:\\Users\\Carl-MainRig\\Projects\\jev-un-squadron\\evidence\\health_observation\\first_damage_"..os.time()
