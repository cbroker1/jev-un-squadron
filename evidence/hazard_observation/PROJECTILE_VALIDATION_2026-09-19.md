...
- `probe_hazards.py` owns only the emulator it starts. `launchers\run_projectile_probe.bat` runs neutral and pulsed-Y captures. Esc, Ctrl+C, and `launchers\stop_projectile_probe.bat` can stop the experiment.
