...
- Rebuilt categorical requests for all 1,015 R99 and 185 R122 decisions without HTTP.
  ...
  A representative body is `samples/categorical_request_example.json`.
...
```powershell
python -m unittest test_bridge test_brain test_combat test_dashboard
python benchmark.py --recent 3 --baseline 12
python runs_table.py --last 12 --full-level-only
python run_segment.py --mode live --stepped --prelude-fire --interval 3 --max-calls 2400 --frames 6000 --change "description"
python run_segment.py --mode live --stepped --prelude-fire --interval 3 --max-calls 400 --frames 1000 --load-slot 3 --expected-start-frame 24121 --warmup 12 --change "description"
```
